...
- [ ] **C0 — Quality gate redefinition** (patch audit endpoint to use composite 3-condition gate + exclude 18 non-domain types from coverage denominator); waits for "C0" trigger after D1 done
